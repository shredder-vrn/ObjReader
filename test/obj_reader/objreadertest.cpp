...
void ObjReaderTest::testParseVertexLine()
{
    ...
    bool result = parseVertex(tokens, model, lineNum, QString());
...
void ObjReaderTest::testParseTexCoordLine()
{
    ...
    bool result = parseTexCoord(tokens, model, lineNum, QString());
    QCOMPARE(result, expectedResult);
}
...
void ObjReaderTest::testParseNormalLine()
{
    ...
    bool result = parseNormal(tokens, model, lineNum, QString());
    QCOMPARE(result, expectedResult);
}
...
void ObjReaderTest::testParseFaceLine()
{
    ...
    bool result = parseFace(tokens, model, lineNum, QString());
    QCOMPARE(result, expectedResult);
}
