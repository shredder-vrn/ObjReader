...
bool ModelController::loadModel(const QString &filePath, const int a)
{
    ...
    QVector<int> faceVertexIndices = newData.faceVertexIndices();
    QVector<int> faceTextureVertexIndices = newData.faceTextureVertexIndices();
    QVector<int> faceNormalIndices = newData.faceNormalIndices();
    QVector<int> polygonStarts = newData.polygonStarts();
    simpleTriangulateModel(
        newData.vertices(),
        faceVertexIndices,
    ...
    newData.setFaceVertexIndices(faceVertexIndices);
    newData.setFaceTextureVertexIndices(faceTextureVertexIndices);
    newData.setFaceNormalIndices(faceNormalIndices);
    newData.setPolygonStarts(polygonStarts);
